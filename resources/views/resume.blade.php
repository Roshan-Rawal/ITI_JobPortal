  ...
  <div class="row">
      <div class="col-md-2">
        ...
        <div class="col-md-7">          
            ...
            <div class="col-md-12">
            <div class="btn-group">
              <a style="background-color:#337ab7;font-size:20px;color:white" href="#" class="btn btn-default" role="button">Resume</a>
              <a style="background-color:#337ab7;font-size:20px;color:white" href="\application" class="btn btn-default" role="button">Application</a>
                </div></div>
            <div class="col-md-2"><img style="border-radius:40px;margin-top:10px" src="img/{{$user->photo}}" class="img-thumbnail" alt="Cinque Terre"></div>
            <div class="col-md-10" style="margin-top:10px"><b style="font-size:20px">Name      :{{$user->fname}}&nbsp;{{$user->lname}}</b></div>
            <div class="col-md-10"><b style="font-size:20px">Email Id  :{{$user->email}}</b></div>
            <div class="col-md-10"><b style="font-size:20px">Contact   :{{$user->mobile}}</b></div>
            </div><br />
            <div class="col-md-12"><b style="font-size:20px">Education&nbsp &nbsp: {{$user->education}}</b></div>
            <div class="col-md-12"><b style="font-size:20px">Gender&nbsp &nbsp &nbsp  : {{$user->gender}} </b></div>
            <div class="col-md-12"><b style="font-size:20px">Course&nbsp &nbsp &nbsp &nbsp &nbsp        : {{$user->course}}</b></div>
            <div class="col-md-12"><b style="font-size:20px">Trade  : {{$user->trade}}</b></div>
            <div class="col-md-12"><b style="font-size:20px">Passing Year : {{$user->passyear}}</b></div>
            <div class="col-md-12"><b style="font-size:20px">Percentage : {{$user->perc}}</b></div>
            <div class="col-md-12"><b style="font-size:20px"> Experience Type : {{$user->extype}}</b></div>
            <div class="col-md-12"><b style="font-size:20px">Experience : {{$user->experience}}</b></div>
            <div class="col-md-12"><b style="font-size:20px">Age :{{$user->age}}</b></div>

            <div class="col-md-12"><b style="font-size:20px">City :{{$user->city}}</b></div>
            <div class="col-md-12"><b style="font-size:20px">Address :{{$user->address}}</b></div>
                 
        </div>

        <!-- Trigger the modal with a button -->
<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModalupdateprofile">Update</button>
<a style="background-color:#337ab7;font-size:20px;color:white" href="\buildresume" class="btn btn-default" role="button">Build Resume</a>

<!-- Modal -->
<div id="myModalupdateprofile" class="modal fade myModalupdateprofile" role="dialog">
       ...
       <form action="" method="">
        <h3>Personal Details:</h3><br>
                      <form id="contactform" action="/jobseeker/register" method="post" enctype="multipart/form-data"> 
                        ...
                        <textarea tabindex="9" rows="3" cols="30" name="address"></textarea><br>
                         ...
                         <label>Upload photo</label><br>
                          ...
                          <br> 
                            ...
                            <br>
                          <input type="text" name="itiname"><br><br>
                          ...
                          <label>Passout Year: </label><br> 
                          <input type="text" name="pyear"><br><br>
                          <label>ITI Course</label><br>
                          ...
                          <input type="text" name="perc" placeholder="Percentage of Course"><br><br>
                        ...
                        <input type="password" id="repassword" name="password_confirmation" required="" tabindex="5"><br><br>
